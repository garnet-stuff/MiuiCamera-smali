...
.method private static final buildIndex(Ljava/util/List;)Ljava/util/Map;
    ...
    invoke-static {v1, v2}, Lsk/e0;->p5(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;
...
.method public static final openZip(Lokio/Path;Lokio/FileSystem;Lnl/l;)Lokio/ZipFileSystem;
    .locals 18
    .param p0    # Lokio/Path;
    ...
    :cond_1
    sget-object v9, Lqk/m2;->a:Lqk/m2;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_7

    :try_start_3
    invoke-static {v8, v7}, Lil/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    sget-object v10, Lqk/m2;->a:Lqk/m2;
    :try_end_7
    .catchall {:try_start_7 .. :try_end_7} :catchall_0

    :try_start_8
    invoke-static {v4, v7}, Lil/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_8
    ...
    :try_start_b
    invoke-static {v4, v1}, Lil/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    :cond_4
    :goto_1
    sget-object v4, Lqk/m2;->a:Lqk/m2;
    :try_end_b
    ...
    :try_start_e
    invoke-static {v8, v1}, Lil/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v2, v13}, Lnl/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v3, v7}, Lil/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v3, v1}, Lil/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    throw v2
.end method

.method public static synthetic openZip$default(Lokio/Path;Lokio/FileSystem;Lnl/l;ILjava/lang/Object;)Lokio/ZipFileSystem;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lokio/internal/ZipKt;->openZip(Lokio/Path;Lokio/FileSystem;Lnl/l;)Lokio/ZipFileSystem;
...
.method public static final readEntry(Lokio/BufferedSource;)Lokio/internal/ZipEntry;
    ...
    invoke-static {v2, v3, v3, v1, v0}, Lbm/c0;->V2(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
    ...
    invoke-static {v8, v15, v13}, Lokio/internal/ZipKt;->readExtra(Lokio/BufferedSource;ILnl/p;)V
    ...
    invoke-static {v2, v1, v3, v4, v12}, Lbm/b0;->K1(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
...
.method private static final readExtra(Lokio/BufferedSource;ILnl/p;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, v8, v9}, Lnl/p;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static final readOrSkipLocalHeader(Lokio/BufferedSource;Lokio/FileMetadata;)Lokio/FileMetadata;
    ...
    invoke-static {v0, v5, v2}, Lokio/internal/ZipKt;->readExtra(Lokio/BufferedSource;ILnl/p;)V
