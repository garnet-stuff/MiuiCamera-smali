...
# direct methods
.method public constructor <init>([Lfr/o;Ljava/lang/Iterable;Lio/reactivex/functions/Function;IZ)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableZip;->sources:[Lfr/o;
...
.method public subscribeActual(Lfr/p;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableZip;->sources:[Lfr/o;
    ...
    invoke-direct/range {v1 .. v6}, Lio/reactivex/internal/operators/flowable/FlowableZip$ZipCoordinator;-><init>(Lfr/p;Lio/reactivex/functions/Function;IIZ)V

    invoke-interface {p1, v8}, Lfr/p;->onSubscribe(Lfr/q;)V

    invoke-virtual {v8, v0, v7}, Lio/reactivex/internal/operators/flowable/FlowableZip$ZipCoordinator;->subscribe([Lfr/o;I)V
