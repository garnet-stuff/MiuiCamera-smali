...
.method public static subscribe(Lfr/p;Ljava/util/Iterator;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-interface {p0, v0}, Lfr/p;->onSubscribe(Lfr/q;)V
    ...
    invoke-direct {v0, p0, p1}, Lio/reactivex/internal/operators/flowable/FlowableFromIterable$IteratorSubscription;-><init>(Lfr/p;Ljava/util/Iterator;)V
...
.method public subscribeActual(Lfr/p;)V
    ...
    invoke-static {p1, p0}, Lio/reactivex/internal/operators/flowable/FlowableFromIterable;->subscribe(Lfr/p;Ljava/util/Iterator;)V
