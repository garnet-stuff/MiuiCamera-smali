...
.method public static A(Ljava/nio/ByteBuffer;Ljava/lang/String;I)V
    ...
    invoke-static {p1}, Lwq/c;->a(Ljava/lang/String;)[B
    ...
    invoke-static {p0, p2}, Lwq/c;->u(Ljava/nio/ByteBuffer;I)I
...
.method public static c(Ljava/lang/Iterable;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0, v1}, Lwq/c;->y(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)V
...
.method public static e(Ljava/nio/channels/ReadableByteChannel;I)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, p1}, Lwq/c;->m(Ljava/nio/channels/ReadableByteChannel;Ljava/nio/ByteBuffer;)I
...
.method public static final i(Ljava/lang/String;)Ljava/nio/MappedByteBuffer;
    ...
    invoke-static {v0}, Lwq/c;->j(Ljava/io/File;)Ljava/nio/MappedByteBuffer;
...
.method public static n(Ljava/nio/ByteBuffer;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lwq/c;->o(Ljava/nio/ByteBuffer;Ljava/lang/String;)Ljava/lang/String;
...
.method public static o(Ljava/nio/ByteBuffer;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {v0}, Lwq/c;->v(Ljava/nio/ByteBuffer;)[B

    move-result-object p0

    invoke-static {p0, p1}, Ldr/a;->k([BLjava/lang/String;)Ljava/lang/String;
...
.method public static p(Ljava/nio/ByteBuffer;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lwq/c;->r(Ljava/nio/ByteBuffer;I)Ljava/lang/String;
...
.method public static q(Ljava/nio/ByteBuffer;I)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lwq/c;->k(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, p1}, Lwq/c;->k(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;

    move-result-object p0

    invoke-static {p0}, Lwq/c;->v(Ljava/nio/ByteBuffer;)[B

    move-result-object p0

    invoke-static {p0}, Ldr/a;->j([B)Ljava/lang/String;
...
.method public static s(Ljava/io/File;)Lwq/a;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-direct {v0, p0}, Lwq/a;-><init>(Ljava/nio/channels/FileChannel;)V

    return-object v0
.end method

.method public static t(Ljava/io/File;)Lwq/a;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/FileNotFoundException;
...
.method public static x(Ljava/io/File;)Lwq/a;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/FileNotFoundException;
...
.method public static y(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p1, v0}, Lwq/c;->w(Ljava/nio/ByteBuffer;I)[B
